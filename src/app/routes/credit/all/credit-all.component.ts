...
import {CreditPassedComponent} from '../passed/credit-passed.component';

@Component({
  selector: 'app-all',
  templateUrl: './credit-all.component.html'
})
export class CreditAllComponent implements OnInit {
